...
import info.androidhive.retrofit.model.Gift;

/**
 * Created by macstudent on 2017-12-04.
 */

public class UserGiftAdapter extends RecyclerView.Adapter<UserGiftAdapter.UserPhotoViewHolder> {

    private List<Gift> userImages;
    ...
    public UserGiftAdapter(List<Gift> userImages, Context context) {
        this.userImages = userImages;
        this.context = context;
    }

    @Override
    public UserGiftAdapter.UserPhotoViewHolder onCreateViewHolder(ViewGroup parent,
                                                                  int viewType) {
    ...
    public void onBindViewHolder(UserPhotoViewHolder holder, final int position) {
        String userImgUrl = "http://eadate.com/images/gift/" + userImages.get(position).getImageUrl();
